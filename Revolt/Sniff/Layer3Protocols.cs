...
public sealed partial class Sniffer {
    ...
    private static readonly FrozenDictionary<ushort, string> l3ProtocolNames = new Dictionary<ushort, string>() {
        { 0x0600, "XEROX NS IDP" },
        ...
        { 0x88E5, "Media Access Control Security" },
        { 0x88F5, "MVRP - Multiple VLAN Registration Protocol" },
        { 0x88F6, "MMRP - Multiple MAC Registration Protocol" },
        { 0x88F7, "PTP - Precision Time Protocol" },
        { 0x8902, "CFM - Connectivity Fault Management" },
        { 0x8906, "FCoE" },
        { 0x890D, "MACSec" },
        { 0x8915, "RoCE" },
        { 0x891D, "TTEthernet" },
    ...
    public static string GetL3ProtocolName(ushort etherType) =>
        l3ProtocolNames.TryGetValue(etherType, out string name) ? name : "-";
